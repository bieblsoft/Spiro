...
namespace Custom_Control_Designer
{
	...
	[Designer( typeof( Custom_Control_Designer.Design.MarqueeBorderDesigner ) )]
				...
				case MarqueeLightShape.Square:
					{
						...
						g.DrawRectangle( Pens.Black, xPos-1, yPos-1, this.lightSizeValue+1, this.lightSizeValue+1 );
						break;
					}
				case MarqueeLightShape.Circle:
					{
						g.FillEllipse( brush, xPos, yPos, this.lightSizeValue, this.lightSizeValue );
						g.DrawEllipse( Pens.Black, xPos - 1, yPos - 1, this.lightSizeValue + 1, this.lightSizeValue + 1 );
						break;
					}
				default:
					{
